...
<p align="center">
  <img src="docs/assets/logbook-words-published.png" alt="Palabras publicadas, acumuladas por hito: una línea escalonada que crece de 20.197 a 119.654 palabras a lo largo de sesenta y siete hitos" width="680">
</p>
...
├── harness-playbook.html              siete plantillas operativas, abre con el D10, inglés completo
├── playbook/
│   ├── README.md                      índice, siete plantillas en ocho archivos, cada una atada a su parte
│   └── ...                            task-contract.md, skill-template.md, y seis más
├── sources/
