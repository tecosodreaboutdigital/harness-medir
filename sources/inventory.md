...
| V | BlueRock, MCP fURI, SSRF in Microsoft MarkItDown MCP | https://www.bluerock.io/post/mcp-furi-microsoft-markitdown-vulnerabilities | Vendor research (BlueRock sells MCP security products), not an independent audit. 7,000+ MCP servers scanned, 36.7% potentially SSRF-vulnerable; PoC recovered a real AWS access key via EC2 metadata. BlueRock's own public registry now shows a different, superseded figure (12,000+/33%) |
