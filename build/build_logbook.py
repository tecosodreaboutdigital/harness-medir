...
COMMIT_TXT = {
    ...
    'beca061': {
        'pt': 'Diário de bordo regerado com três marcos novos: a regeneração anterior propriamente dita (M56, 2d6e59b), a limpeza de travessão em escala do projeto inteiro (M57, dc554f2, cerca de 64 ocorrências corrigidas caso a caso), e a sincronização de NEXT-STEPS.pt/es com o rastreador em inglês (M58, ad9402e). Cinquenta e oito marcos completos, 117.677 palavras publicadas, cerca de 2.005,3 milhões de tokens transacionados pela contagem então em uso, que a regeneração seguinte encontraria dobrada por um bug de deduplicação.',
        'en': 'Project log regenerated with three new milestones: the previous regeneration itself (M56, 2d6e59b), the project-wide em-dash cleanup (M57, dc554f2, roughly 64 occurrences fixed case by case), and the NEXT-STEPS.pt/es sync with the English tracker (M58, ad9402e). Fifty-eight milestones complete, 117,677 words published, about 2,005.3 million tokens transacted by the count then in use, which the next regeneration would find doubled by a deduplication bug.',
        'es': 'Diario de bordo regenerado con tres hitos nuevos: la regeneración anterior propiamente dicha (M56, 2d6e59b), la limpieza de raya a escala de todo el proyecto (M57, dc554f2, unas 64 apariciones corregidas caso por caso), y la sincronización de NEXT-STEPS.pt/es con el rastreador en inglés (M58, ad9402e). Cincuenta y ocho hitos completos, 117.677 palabras publicadas, cerca de 2.005,3 millones de tokens transaccionados por el conteo entonces en uso, que la siguiente regeneración encontraría duplicado por un bug de deduplicación.',
    },
    'e6db873': {
